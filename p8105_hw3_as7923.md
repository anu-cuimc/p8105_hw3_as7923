...
Before beginning, loading core libraries (tidyverse, patchwork), and
setting global setting for visualizations.
...
An example observation above shows that Bulgarian Yogurt (product ID
49302) from the yogurt aisle in the dairy eggs department was ordered.
This order was part of order ID 1, placed on day 4 (Thursday) at hour
10, and it was the 9th item added to the cart.
...
Top 5 most ordered from aisles
...
This plot displays the 39 aisles that have more than 10,000 items
ordered. The aisles are arranged in ascending order by no. of items
ordered, making it easy to identify the most and least popular aisles
within this threshold. Fresh vegetables and fresh fruits clearly
...
Three most popular items in specific aisles

The table above shows the three most popular items in each of the
specified aisles. In the baking ingredients aisle, Light Brown Sugar is
the most popular item with 499 orders, followed by Pure Baking Soda (387
orders) and Cane Sugar (336 orders). For dog food care, Snack Sticks
Chicken & Rice Recipe Dog Treats is at the top with 30 orders, followed
by Organix Chicken & Brown Rice Recipe (28 orders) and Small Dog
Biscuits (26 orders). The packaged vegetables fruits aisle shows
significantly higher order volumes, with Organic Baby Spinach being
significantly popular at 9784 orders, followed by Organic Raspberries
(5546 orders) and Organic Blueberries (4966 orders).
...
Mean hour of day for Pink Lady Apples and Coffee Ice Cream orders

This table shows the mean hour of the day at which Pink Lady Apples and
Coffee Ice Cream are ordered for each day of the week. Pink Lady Apples
are generally ordered between 11 AM and 2 PM across all days. Coffee Ice
Cream shows a slightly different pattern, typically ordered between noon
and 4 PM, . Overall, both products tend to be ordered during late
mornings to early afternoon hours, with Coffee Ice Cream ordered
slightly later in the day than Pink Lady Apples on most days.
...
The plots above illustrate substantial variation in rental prices both
between and within boroughs. New York shows the highest median rental
price and the widest range, with some ZIP codes exceeding \$6,000 per
month. Kings displays significant variation with several higher-priced
outlier ZIP codes comparable to New York prices. Queens shows a more
compressed distribution with moderate prices and few extreme outliers.
...
relatively similar within each education level, with one notable
exception: in the “More than high school” category, there are notably
more young adult females compared to males in the same age range.
...
6 AM), increases during morning hours, peaks during midday and afternoon
(approximately 8 AM to 4 PM), and declines in the evening. Across all
